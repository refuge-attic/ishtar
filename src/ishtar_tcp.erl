%%% -*- erlang -*-
%%%
%%% This file is part of ishtar released under the Apache 2 license.
...
listen(Port, Opts) ->
    BaseOpts = [binary,
                ...
                {reuseaddr, true},
                {nodelay, true}],
    Opts1 = ishtar_util:filter_props(Opts, [backlog, ip, nodelay, port,
                                            raw], BaseOpts),
    lager:info("opts ~p~n", [ishtar_util:fix_ip(Opts1)]),
    gen_tcp:listen(Port, ishtar_util:fix_ip(Opts1)).
